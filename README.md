...
Input Validation: Uses try-except blocks to ensure only integers are processed.

Error Handling: Prevents crashes from unsupported operators and division by zero.
